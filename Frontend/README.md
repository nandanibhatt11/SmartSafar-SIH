...
- `src/App.jsx` — main application and demo data
- `src/components/HeroSection.jsx`
- `src/components/TelemetrySection.jsx`
...
The demo uses remote Unsplash images and CARTO/Leaflet map tiles, so an internet connection is required for those visual assets.
